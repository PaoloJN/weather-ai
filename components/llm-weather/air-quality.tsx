...
export default function AirQuality({ data, className }: AirQualityProps) {
  return (
    <div>
      <Card
        className={cn(
          'col-span-2 flex h-48 flex-col justify-between',
          className
        )}
      >
        <CardHeader>
        ...
        <CardContent className="my-auto space-y-5">
          <span>53 Moderate</span>
          <Progress aria-label="Air pollution" value={data.main.aqi * 10} />
        </CardContent>
