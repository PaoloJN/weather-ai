...
import { BotMessageText } from '@/components/llm-stocks/message'
...
let textStreamTwo: undefined | ReturnType<typeof createStreamableValue<string>>
let textNodeTwo: undefined | React.ReactNode
...
Besides that, you can also chat with users and do some calculations if needed.`
      ...
      },
      {
        ...
        parameters: z.object({
          message: z
            ...
            .optional()
            .describe(
              'A short Message to show to the user while searching stocks in the context of the conversation'
            ),
          stocks: z.array(
            z.object({
  ...
  completion.onTextContent((content: string, isFinal: boolean) => {
    if (!textStream) {
      ...
      textNode = <BotMessageText content={textStream.value} />
    }
